...
insert into	"ACCOUNT"("ACC_ID", "EMAIL" ,"PASSWORD", "NAME", "COMP_ID", "POSITION", "PERMISSION") values (1, 'robert@example.com', 'secret', 
	'Robert Adamski', 101, 'admin', 'Administrator');
insert into "ACCOUNT"("ACC_ID", "EMAIL", "PASSWORD", "NAME", "COMP_ID", "POSITION", "PERMISSION") values (2, 'marcin@example.com', 'secret',
	'Marcin Król', 49, 'sprzedaż', 'NormalUser');
insert into "ACCOUNT"("ACC_ID", "EMAIL", "PASSWORD", "NAME", "COMP_ID", "POSITION", "PERMISSION") values (3, 'przemek@example.com', 'secret', 
