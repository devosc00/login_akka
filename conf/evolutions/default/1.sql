...
create table "COMPANIES" ("COMP_ID" BIGSERIAL NOT NULL PRIMARY KEY,"COMP_NAME" VARCHAR(254) NOT NULL,"STREET" VARCHAR(254) NOT NULL,"CITY" VARCHAR(254) NOT NULL,"ZIP" VARCHAR(254) NOT NULL);
